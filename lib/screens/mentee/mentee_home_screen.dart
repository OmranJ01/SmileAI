...
import 'dart:async';
import '../../screens/mentee/mentee_dashboard_screen.dart';
import '../../screens/common/notifications_screen.dart';
import '../../screens/mentee/mentee_chat_screen.dart';
...
class _MenteeHomeScreenState extends State<MenteeHomeScreen> {
  ...
  // Create a new MenteeChatScreen class
  static final List<Widget> _screens = [
    MenteeDashboardScreen(),
    DiscoverScreen(),
    NotificationsScreen(),
    MenteeChatScreen(), // New MenteeChatScreen instead of SettingsScreen
  ];
  ...
  void _setupNotificationBadgeListener() {
    ...
    print('🔔 Setting up notification badge listener for mentee ${appState.user!.uid}');
  ...
  void _onTabTapped(int index) {
    ...
    if (index == 2 && _unreadNotificationCount > 0) {
    ...
    if (index == 1 && _newArticlesCount > 0) {
  ...
  // ADDED: Dynamic app bar title based on selected tab (like mentor)
